...
const Cart = () => {
  ...
  return (
    <section>
      <div className="container px-6 m-auto pt-10">
        <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
          <div className="col-span-4 lg:col-span-8 pt-4">
            {cartArray.length > 0 ? (
              cartArray.map((c) => (
                <CartItem refreshPage={refreshPage} detail={c} key={c.id} />
              ))
            ) : (
              <h1 className="text-4xl font-bold my-40 text-end">
              ...
              <div className="w-4/5">
                <div className="border-solid border-2 rounded-xl p-4 w-full shadow-lg">
                  ...
                  <div className="mt-6 mb-2">
                    <button
                      onClick={() =>
                        toast.success("Congratulations, Order Confirmed!!")
                      }
                      className="p-3 bg-green-500 hover:bg-green-600 w-full text-white font-bold"
                    >
                      Order
                    </button>
                  </div>
