...
const Login = () => {
    return (
        <div className='flex gap-20 justify-center items-center py-10 flex-row-reverse'>
            <form className="overflow-hidden rounded bg-white text-slate-500 shadow-lg shadow-slate-300 border border-sky-200 h-96 w-80">
                {/*  <!-- Body--> */}
                <div className="p-6">
                    ...
                    <div className="flex flex-col space-y-8">
                        ...
                        <div className="relative my-6">
                            <input
                                ...
                                className="peer relative h-10 w-full rounded border border-slate-200 px-4 text-sm text-slate-500 placeholder-transparent outline-none transition-all bg-white invalid:border-pink-500 invalid:text-pink-500 focus:border-emerald-500 focus:outline-none invalid:focus:border-pink-500 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400 "
                            />
                            <label
                                htmlFor="id-b03"
