    ...
    return (
        <div>
            <div className='md:flex min-h-screen'>
                ...
                <div className={`md:p-4 p-3 md:pb-12 space-y-2 md:w-72 bg-gray-50 text-black absolute inset-y-0 left-0 transform ${translate ? '-translate-x-full' : ''} transition duration-200 ease-in-out md:relative md:translate-x-0 z-20`}>
                    ...
                    <div className="divide-y divide-gray-300">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            <li className="text-black hover:text-white">
                                <Link to='/dashboard/user-requests' className="flex items-center p-2 space-x-3 hover:bg-purple-800 focus:bg-purple-700 text-black hover:text-white rounded-md">
                            ...
                            <li>
                                <Link to='/dashboard/host-request' className="flex items-center p-2 space-x-3 hover:bg-purple-800 focus:bg-purple-700 text-black hover:text-white rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-black hover:text-white">
