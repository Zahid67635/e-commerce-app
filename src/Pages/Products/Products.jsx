  ...
  return (
    <div>
      <div className="md:flex justify-between pb-8">
        <h1 className="md:text-3xl text-2xl px-2 md:px-0 pb-2 font-bold">
          All Products:{" "}
        </h1>
        <div className="px-2 md:px-0 flex items-center">
          <h1 className="pr-2 font-bold hidden md:block text-orange-500">
            Categories:{" "}
          </h1>
          <button
            onClick={handleAll}
            className={`p-2 px-3 text-sm font-semibold rounded-xl shadow-sm shadow-gray-300 ${
              activeAll ? "bg-sky-500 text-white" : ""
            }`}
          >
            All
          </button>
          <button
            ...
            className={`p-2 text-sm font-semibold rounded-xl shadow-sm shadow-gray-300 mx-2 ${
          ...
          <button
            ...
            className={`p-2 text-sm font-semibold rounded-xl shadow-sm shadow-gray-300 mx-2 ${
              activeCloth ? "bg-sky-500 text-white" : ""
            }`}
          >
            Clothing
          </button>
          <button
            ...
            className={`p-2 text-sm font-semibold rounded-xl shadow-sm shadow-gray-300 ${
              activeElec ? "bg-sky-500 text-white" : ""
            }`}
          >
            Electronics
          </button>
      ...
      {loading ? (
        ...
        <div className="md:grid grid-cols-3 gap-8 p-3 md:p-0">
          {products.map((p) => (
            <ProductCard details={p} key={p.id} />
          ))}
        </div>
      )}
    </div>
