    ...
    return (
        <div className="md:mb-0 mb-3">
            <div className="overflow-hidden rounded-lg bg-white text-slate-500 shadow-lg shadow-pink-300 md:h-[430px] md:w-[350px] relative">
                <span className="absolute top-0 right-0 px-5 py-1 text-xs tracki text-center uppercase whitespace-no-wrap origin-bottom-left transform rotate-45 -translate-y-full translate-x-1/3 bg-pink-400 text-white">New</span>
                {/*  <!-- Image --> */}
                <figure>
                    <img
                        src={image}
                ...
                <div className="p-6">
                    ...
                    <p className="flex">
                        Rating: {rating.rate} <HiStar className="text-yellow-500 text-xl mt-[-2px]" /> <span>({rating.count})</span>
                    </p>
                </div>
